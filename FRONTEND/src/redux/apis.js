...
// editNote
export const edit_Note = ({ id, note, category, startDate, endDate, description, priority, done}) => {
  return axios.post(`${REACT_APP_BASE_URL}/editNote`, { id, note, category, startDate, endDate, description, priority, done});
};
